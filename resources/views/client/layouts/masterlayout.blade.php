                    ...
                    <div class="col-12 col-sm-2 col-lg-5">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu p-0 fables-forth-background-color rounded-0 m-0 border-0 lang-dropdown" aria-labelledby="dropdownLangButton">
                                <a class="dropdown-item white-color font-13 fables-second-hover-color" href="{{route('job-post')}}">Job Post</a>
                                <a class="dropdown-item white-color font-13 fables-second-hover-color" href="#">Others</a>
                            </div>
                        </div>

                    </div>
                    <div class="col-12 col-sm-5 col-lg-4 text-right">
                        <p class="fables-third-text-color font-13"><span class="fables-iconphone"></span> Phone : (+880) 1610158095 - (+880) 1760158095</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-2 col-lg-3 pr-md-0 icons-header-mobile">
                        ...
                        <div class="fables-header-icons">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <div class="p-3 cart-block">
                                        ...
                                        <div class="row mx-0 mb-3">
                                            <div class="col-4 p-0">
                                                <a href="#"><img src="masterlayouts/assets/custom/images/sml1.jpg" alt="" class="w-100"></a>
                                            </div>
                                            <div class="col-8">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle  mb-0 pb-0 fables-second-hover-color font-13 top-header-link px-3 px-md-2 px-lg-4 max-line-height" id="sub-nav4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="{{asset('uploads/user')}}/{{$data->image}}" style="width: 25px; height: 25px; border-radius: 50%; cursor: pointer;">
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="sub-nav4">
